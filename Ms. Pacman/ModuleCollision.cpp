...
ModuleCollision::ModuleCollision()
{
	...
	matrix[COLLIDER_PILL][COLLIDER_ENEMY] = false;
	...
	matrix[COLLIDER_POWER_PILL][COLLIDER_ENEMY] = false;
	...
	matrix[COLLIDER_FRUITS][COLLIDER_ENEMY] = false;
...
void ModuleCollision::DebugDraw()
{
	...
	for (uint i = 0; i < MAX_COLLIDERS; ++i)
	{
		...
		case COLLIDER_ENEMY: // red
			...
			break;
		case COLLIDER_PILL: // yellow
			App->render->DrawQuad(colliders[i]->rect, 255, 255, 0, alpha);
			break;
		case COLLIDER_POWER_PILL: // cyan
			App->render->DrawQuad(colliders[i]->rect, 0, 255, 255, alpha);
			break;
		case COLLIDER_FRUITS: // magenta
